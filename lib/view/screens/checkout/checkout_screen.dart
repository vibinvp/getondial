...
import 'package:getondial/controller/coupon_controller.dart';
...
import 'package:getondial/data/model/body/place_order_body.dart';
import 'package:getondial/data/model/response/address_model.dart';
import 'package:getondial/data/model/response/cart_model.dart';
import 'package:getondial/data/model/response/config_model.dart';
...
import 'package:getondial/helper/date_converter.dart';
...
import 'package:getondial/view/base/custom_dropdown.dart';
...
import 'package:getondial/view/base/image_picker_widget.dart';
...
import 'package:getondial/view/screens/cart/widget/delivery_option_button.dart';
import 'package:getondial/view/screens/checkout/widget/condition_check_box.dart';
import 'package:getondial/view/screens/checkout/widget/coupon_bottom_sheet.dart';
import 'package:getondial/view/screens/checkout/widget/delivery_instruction_view.dart';
import 'package:getondial/view/screens/checkout/widget/payment_method_bottom_sheet.dart';
import 'package:get/get.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';
import 'package:getondial/view/screens/checkout/widget/time_slot_bottom_sheet.dart';
import 'package:getondial/view/screens/checkout/widget/tips_widget.dart';
import 'package:getondial/view/screens/home/home_screen.dart';
import 'package:getondial/view/screens/store/widget/camera_button_sheet.dart';
...
class CheckoutScreenState extends State<CheckoutScreen> {
  ...
  List<DropdownItem<int>> sex = [];
  List sexText = ['Male', 'Female', 'Other'];
  ...
  sexFunction() {
    for (int index = 0; index < sexText.length; index++) {
      sex.add(DropdownItem<int>(
          value: index,
          child: SizedBox(
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text(sexText[index]),
            ),
          )));
    }
  }
                ...
                return GetBuilder<CouponController>(
                  ...
                  return GetBuilder<OrderController>(
                    ...
                    if (storeController.store != null &&
                      ...
                      print(
                          "perKmShippingCharge${storeController.store!.perKmShippingCharge!}");
                      print(
                          "charge = ${orderController.distance! * storeController.store!.perKmShippingCharge!}");
                      print(
                          "maximumcharge =${storeController.store!.maximumShippingCharge}");
                      ...
                      if (deliveryCharge < moduleData.minimumShippingCharge!) {
                        ...
                        deliveryCharge = double.parse(
                            moduleData.maximumShippingCharge.toString());
                        charge = double.parse(
                            moduleData.maximumShippingCharge.toString());
                      }
                    }
                    ...
                    if (taxIncluded) {
                      print("tax percent = $_taxPercent");
                      tax = orderAmount * _taxPercent! / (100);
                      print("tax = $tax");
                    } else {
                    ...
                    print("total =$total");
                    if (kDebugMode) {
                      // log('Total calculation------>>>      ${subTotal + deliveryCharge - discount - couponDiscount + (taxIncluded ? 0 : tax) + (orderController.orderType != 'take_away' ? orderController.tips : 0)}');
                      // log('Total calculation------>>>      ${orderController.tips}');
                      // log('Total calculation------>>>      ${orderController.orderType}');
                      print(
                          'Total calculation------>>>      ${subTotal + deliveryCharge - discount - couponDiscount + (taxIncluded ? tax : 0) + (orderController.orderType != 'take_away' ? orderController.tips : 0)}');
                      print(
                          'Total calculation---Tip--->>>      ${orderController.tips}');
                      print(
                          'Total calculation---orderType--->>>      ${orderController.orderType}');
                    }
      ...
      child: Column(children: [
        ...
        Get.find<SplashController>().module!.id == 2 ||
            ...
            : !takeAway
                ? Center(
                    child: Text(
                    '${'delivery_charge'.tr}: ${storeController.store!.freeDelivery! ? 'free'.tr : orderController.distance != -1 ? PriceConverter.convertPrice(charge) : 'calculating'.tr}',
        ...
        Container(
          ...
          child:
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Get.find<SplashController>().module!.id == 2
                  ? Text('Your Address', style: robotoMedium)
                  : Get.find<SplashController>().module!.id == 3
                      ? Text('Your Address', style: robotoMedium)
                ...
                onPressed: () async {
                  var address = await Get.toNamed(
                      RouteHelper.getAddAddressRoute(
                          true, false, storeController.store!.zoneId));
                  if (address != null) {
            ...
            Container(
              ...
              child: CustomDropdown<int>(
                onChange: (int? value, int index) {
                  ...
                  _streetNumberController.text =
                      address[orderController.addressIndex!].streetNumber ?? '';
                  _houseController.text =
                ...
                child: Column(
                    ...
                    children: [
                      Row(children: [
                        Get.find<SplashController>().module!.id == 2 ||
                                Get.find<SplashController>().module!.id == 3
                            ? Text('Book Slot'.tr, style: robotoMedium)
                        ...
                        JustTheTooltip(
                          ...
                          content: Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Get.find<SplashController>().module!.id == 2
                                ? Text(
                                    'You can book appointment at any provided time'
                                        .tr,
                                    style: robotoRegular.copyWith(
                                        color: Colors.white))
                                : Text('schedule_time_tool_tip'.tr,
                                    style: robotoRegular.copyWith(
                                        color: Colors.white)),
                          ),
                          child: InkWell(
      ...
      child: Column(children: [
        ...
        Container(
          ...
          child:
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Get.find<SplashController>().module!.id == 2
                ? Text('Patient Name'.tr, style: robotoMedium)
                : Container(),
            Get.find<SplashController>().module!.id == 2
                ? const SizedBox(height: Dimensions.paddingSizeSmall)
                : Container(),
                    ...
                    children: [
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Age'.tr, style: robotoMedium),
                            const SizedBox(height: Dimensions.paddingSizeSmall),
                            CustomTextField(
                      ...
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Sex'.tr, style: robotoMedium),
                            const SizedBox(height: Dimensions.paddingSizeSmall),
                            // CustomTextField(
                            ...
                            Container(
                              ...
                              child: CustomDropdown<int>(
                                onChange: (int? value, int index) {
                                  orderController.setTypeIndex(index, true);
                                  _patientSexController.text = sexText[index];
                                  // log(_patientSexController.text.toString());
                                },
                                dropdownButtonStyle: DropdownButtonStyle(
                                  height: 50,
                                  padding: const EdgeInsets.symmetric(
            ...
            CustomTextField(
              ...
              titleText: Get.find<SplashController>().module!.id == 2
                  ? 'Ex: I have fever'
                  : Get.find<SplashController>().module!.id == 3
                      ? 'Ex: Fan repair'
                      : 'please_provide_extra_napkin'.tr,
              maxLines: 3,
              inputType: TextInputType.multiline,
              inputAction: TextInputAction.done,
              capitalization: TextCapitalization.sentences,
  ...
  Widget _orderPlaceButton(
    ...
    return Container(
      ...
      child: CustomButton(
          ...
          buttonText: Get.find<SplashController>().module!.id == 2 ||
                  Get.find<SplashController>().module!.id == 3
              ? 'Confirm Booking'
              : 'confirm_order'.tr,
                    ...
                    if (widget.storeId == null) {
                      ...
                      orderController.placeOrder(
                          PlaceOrderBody(
                            ...
                            contactPersonName: Get.find<SplashController>()
                                        .module!
                                        .id ==
                                    2
                            ...
                            sex: _patientSexController.text == "" ||
                                    _patientSexController.text.isEmpty
                                ? ''
                                : _patientSexController.text,
