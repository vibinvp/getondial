...
import 'package:getondial/view/base/custom_divider.dart';
...
import 'package:getondial/view/screens/order/widget/address_details.dart';
      ...
      child: (!takeAway && track.deliveryMan == null) ? Padding(
        ...
        Align(alignment: Alignment.centerLeft, child: Text(
          takeAway ? Get.find<SplashController>().configModel!.moduleConfig!.module!.showRestaurantText!
              ? 'store'.tr :track.moduleType=='pharmacy' ?'Clinic': 'store'.tr : 'delivery_man'.tr,
