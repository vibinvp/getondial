...
import 'package:getondial/data/model/response/order_details_model.dart';
...
import 'package:getondial/view/base/confirmation_dialog.dart';
...
import 'package:getondial/view/screens/chat/widget/image_dialog.dart';
import 'package:getondial/view/screens/order/widget/cancellation_dialogue.dart';
import 'package:getondial/view/screens/order/widget/delivery_details.dart';
import 'package:getondial/view/screens/order/widget/order_item_widget.dart';
import 'package:getondial/view/screens/parcel/widget/details_widget.dart';
import 'package:getondial/view/screens/review/rate_review_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:getondial/view/screens/store/widget/review_dialog.dart';
...
class OrderDetailsScreenState extends State<OrderDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
        appBar: CustomAppBar(
            title: widget.orderModel!.moduleType == 'pharmacy'
                ? 'Appointment Details'
                : widget.orderModel!.moduleType == 'ecommerce'
                    ? 'Booking Details'
                    : 'order_details'.tr,
            onBackPressed: () {
              if (widget.fromNotification) {
                                ...
                                Column(
                                    ...
                                    children: [
                                        ...
                                        child: Column(
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: Row(children: [
                                                  Text(
                                                      '${parcel ? 'charge_pay_by'.tr : widget.orderModel!.moduleType == 'pharmacy' ? 'Appointment ' : widget.orderModel!.moduleType == 'ecommerce' ? 'Booking ' : 'item'.tr}:',
                                                      style: robotoRegular),
                                                  const SizedBox(
                                                      width: Dimensions
                                                          .paddingSizeExtraSmall),
                                                    ...
                                                    order.orderStatus ==
                                                        ...
                                                        ? widget.orderModel!
                                                                ...
                                                                widget.orderModel!
                                                                        .moduleType ==
                                                                    'ecommerce'
                                                            ? '${'Completed at'} ${DateConverter.dateTimeStringToDateTime(order.delivered!)}'
                                                                  ...
                                                                  children: [
                                                                      ...
                                                                      const SizedBox(
                                                                          height:
                                                                              Dimensions.paddingSizeSmall),
                                                                      (order.refund != null &&
                                                                              order.refund!.customerNote != null)
                                                                          ? InkWell(
                                                              ...
                                                              : Column(
                                                                  ...
                                                                  children: [
                                                                      ...
                                                                      InkWell(
                                                                        onTap: () => Get.dialog(ReviewDialog(
                                                                            review:
                                                                                ReviewModel(comment: order.refund!.adminNote),
                                                          ...
                                                          (!parcel &&
                                                              ...
                                                              ? InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    // print(
                                                                    //     "8547orderId :${order.id}");
                                                                    // print(
                                                                    //     "8547restaurantID :${order.store!.vendorId}");
                                                                    // print(
                                                                    //     "8547user id ;${order.store!.vendorId}");
                                                                    // print("8547fist name :${order.store!.name}");
                                                                    //  print(
                                                                    //     "8547fist name :${order.store!.logo}");
                                                                    await Get.toNamed(
                                                                        RouteHelper
                                                                            .getChatRoute(
                                                    ...
                                                    children: [
                                                        ...
                                                        taxIncluded
                                                            ? Row(
                                                                ...
                                                                children: [
                                                                    Text(
                                                                        '${'vat_tax'.tr} (${order.taxPercentage ?? 0}%)',
                                                                        style:
                                                                            robotoRegular),
                                                                    Text(
                                      ...
                                      ResponsiveHelper.isDesktop(context)
                                          ? _bottomView(orderController, order,
                                              parcel, total)
                                          : const SizedBox(),
                                    ]),
                              ],
                  ...
                  ((order.orderStatus == 'pending' &&
                      ...
                      ? Expanded(
                          child: CustomButton(
                            buttonText: parcel
                                ? 'track_delivery'.tr
                                : widget.orderModel!.moduleType == 'pharmacy'
                                    ? 'Track Appointment'
                                    : widget.orderModel!.moduleType ==
                                            'ecommerce'
                                        ? 'Track Booking'
