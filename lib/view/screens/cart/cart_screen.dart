...
import 'package:getondial/view/base/web_constrained_box.dart';
import 'package:getondial/view/screens/cart/widget/cart_item_widget.dart';
            ...
            child: Column(
              ...
              children: [
                InkWell(
                  ...
                  child: Row(children: [
                    Expanded(
                        child: Text('If it is not available',
                            style: robotoMedium,
                            maxLines: 2,
