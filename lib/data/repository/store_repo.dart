...
class StoreRepo {
  ...
  Future<Response> getStoreList(int offset, String filterBy) async {
    return await apiClient
        .getData('${AppConstants.storeUri}/$filterBy?offset=$offset&limit=10');
  }
  ...
  Future<Response> getStoreVideoUrl(int? moduleId) async {
    return await apiClient.getData(
      '${AppConstants.getVideo}?module_id=$moduleId',
    );
  }
}
